...
- [`brain-pdf`](https://github.com/garrytan/gbrain/tree/HEAD/skills/brain-pdf) — Generate a publication-quality PDF from any brain page via the gstack make-pdf binary.
- [**View all 51 skills →**](https://github.com/garrytan/gbrain)
...
- [`n8n-mcp-tools-expert`](https://github.com/czlonkowski/n8n-skills/tree/HEAD/skills/n8n-mcp-tools-expert) — Expert guide for using n8n-mcp MCP tools effectively.
- [`n8n-node-configuration`](https://github.com/czlonkowski/n8n-skills/tree/HEAD/skills/n8n-node-configuration) — Operation-aware node configuration guidance.
- [`n8n-code-python`](https://github.com/czlonkowski/n8n-skills/tree/HEAD/skills/n8n-code-python) — Write Python code in n8n Code nodes.
- [`n8n-validation-expert`](https://github.com/czlonkowski/n8n-skills/tree/HEAD/skills/n8n-validation-expert) — Interpret validation errors and guide fixing them.
- [`n8n-workflow-patterns`](https://github.com/czlonkowski/n8n-skills/tree/HEAD/skills/n8n-workflow-patterns) — Proven workflow architectural patterns from real n8n workflows.
...
- [**View all 19 skills →**](https://github.com/huifer/Claude-Ally-Health)
...
- [**View all 68 skills →**](https://github.com/alinaqi/maggy)
...
- [`audience-intelligence`](https://github.com/indranilbanerjee/digital-marketing-pro/tree/HEAD/skills/audience-intelligence) — Research target audiences.
- [**View all 154 skills →**](https://github.com/indranilbanerjee/digital-marketing-pro)
